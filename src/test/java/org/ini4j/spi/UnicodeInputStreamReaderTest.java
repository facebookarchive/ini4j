...
public class UnicodeInputStreamReaderTest
{
    ...
    public void testUTF16LE_fail() throws Exception
    {
    ...
    @Test(expected=IllegalStateException.class)
    public void testUTF16BE_fail() throws Exception
    {
    ...
    @Test public void testUTF32LE() throws Exception
    {
        test("UTF-32LE.ini", "UTF-32LE");
    }

    @Test(expected=IllegalStateException.class)
    public void testUTF32LE_fail() throws Exception
    {
        test("UTF-32LE.ini", "ISO-8859-1");
    }

    @Test public void testUTF32LE_BOM() throws Exception
    {
    ...
    @Test public void testUTF32BE() throws Exception
    {
        test("UTF-32BE.ini", "UTF-32BE");
    }

    @Test(expected=IllegalStateException.class)
    public void testUTF32BE_fail() throws Exception
    {
        test("UTF-32BE.ini", "ISO-8859-1");
    }

    @Test public void testUTF32BE_BOM() throws Exception
    {
